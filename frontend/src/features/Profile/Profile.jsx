...
export const Profile = () => {
  ...
  const handleEdit = async () => {
    ...
    try {
      ...
      const response = await fetch(
        "http://localhost:8080/auth/edituser",
        {
          method: "PUT",
          headers: {
            Authorization: `Bearer ${authToken}`,
      ...
      <div className="profile2Container" id="profile2">
        ...
        <div className="profileDetails">
          ...
          <div className="indProfileContent">
            ...
            <p className="indProfileContentValue">{user.phone}</p>
          </div>
          <div className="profileContentDivider" />
          <div className="indProfileContent">
        ...
        <div className="screenView">
          <div className="modalContainer">
            ...
            <div className="modalInputs">
              ...
              <div className="modalIndInput">
                <label htmlFor="phone" className="modalInputLabels">
                  Mobile Number
                </label>
                <input
                  type="number"
              ...
              <div className="modalIndInput">
                <label htmlFor="email" className="modalInputLabels">
                  Email Id
                </label>
                <input
                  type="text"
